...
describe "import handler" do
  ...
  describe '#process' do
    ...
    it 'produces output at the md_destination' do
      _(File.exist?(destination + '/readme.md')).must_equal true
    end
    ...
    describe 'with multiple sources' do
      ...
      it 'processes all sources' do
        _(File.exist?(destination + '/readme.md')).must_equal true
        _(File.exist?(destination + '/todo.md')).must_equal true
      end
    end
    ...
    describe 'producing html' do
      ...
      it 'creates html files' do
        _(File.exist?(destination + '/html/readme.html')).must_equal true
      end
    end
  end
end
